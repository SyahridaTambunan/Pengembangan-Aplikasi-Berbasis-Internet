...
<body>
    ...
    <div class="section">
        <div class="container">
            <h1 class="text-center mt-3 mb-5"> Daftar Kategori </h1>
            ...
            <div class="box">
                <?php 
                    ...
                    {
                        while($queryData = mysqli_fetch_array($queryKategori))
                        {
                ?>
                            <a href="produk.php?Kategori=<?php echo $queryData['id'] ?>">
                                <div class="col-4 kotak">
                                    <img src="../image/ikon.png" width="50px" style="margin-bottom: 5px;">
                                    <p> <?php echo $queryData['nama']; ?> </p>
                                </div>
                            </a>
                <?php
                        }
    ...
    <div class="container-fluid py-5">
        <div class="container">
            ...
            <div class="box">
                <?php
                    $queryProduk = mysqli_query($conn, "SELECT * FROM produk WHERE stok = 'tersedia' LIMIT 12");
